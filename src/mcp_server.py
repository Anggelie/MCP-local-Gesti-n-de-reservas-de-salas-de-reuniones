"""Servidor MCP local manual sobre JSON-RPC 2.0 y stdin/stdout."""
...
class MeetingRoomMcpServer:
    """Implementa el ciclo MCP mínimo para herramientas de reservas."""
    ...
    def handle_message(self, message: Mapping[str, Any]) -> dict[str, Any] | None:
        """Procesa una solicitud o notificación y devuelve su respuesta."""
    ...
    def serve_forever(self) -> None:
        """Lee mensajes JSON por línea y escribe respuestas JSON por línea."""
    ...
    def _tool_definitions() -> list[dict[str, Any]]:
        return [
            {
                "name": "list_rooms",
                "description": "Lista las salas de reuniones y sus características.",
                "inputSchema": {"type": "object", "properties": {}, "additionalProperties": False},
            },
            {
                "name": "check_availability",
                "description": "Comprueba si una sala está disponible en un intervalo.",
                "inputSchema": {"type": "object", "properties": _interval_properties(), "required": ["room_id", "date", "start_time", "end_time"]},
            },
            {
                "name": "create_reservation",
                "description": "Crea una reserva para una sala de reuniones.",
                "inputSchema": {"type": "object", "properties": {**_interval_properties(), "reserved_by": {"type": "string"}, "title": {"type": "string"}}, "required": ["room_id", "date", "start_time", "end_time", "reserved_by", "title"]},
            },
            {
                "name": "cancel_reservation",
                "description": "Cancela una reserva existente.",
                "inputSchema": {"type": "object", "properties": {"reservation_id": {"type": "string"}}, "required": ["reservation_id"]},
            },
            {
                "name": "list_reservations",
                "description": "Lista reservas con filtros opcionales por fecha o sala.",
                "inputSchema": {"type": "object", "properties": {"date": {"type": "string"}, "room_id": {"type": "string"}}, "additionalProperties": False},
            },
        ]
...
def _interval_properties() -> dict[str, dict[str, str]]:
    return {
        ...
        "start_time": {"type": "string", "description": "Formato HH:MM"},
        "end_time": {"type": "string", "description": "Formato HH:MM"},
    }


if __name__ == "__main__":
    MeetingRoomMcpServer().serve_forever()